...
* [UC-06: Create a player](#uc-06-create-player)
* [UC-07: Delete a player](#uc-07-delete-player)
* [UC-08: Create a behavior](#uc-08-create-behavior)
* [UC-09: Edit a behavior](#uc-09-edit-behavior)
* [UC-10: Delete a behavior](#uc-10-delete-behavior)
...
* [UC-17: User joins a public league](#uc-17-user-joins-a-public-league)
...
* [UC-28: Leave a match](#uc-28-leave-a-match)
* [UC-29: Navigate current league](#uc-29-navigate-current-league)
* [UC-30: Spectate a match](#uc-30-spectate-a-match)
* [UC-31: User re-enters a match](#uc-31-user-re-enters-a-match)
...
| UC-11 | CREATE DEFAULT TEAM | |
| - | - | - |
| **Description** | The user configures a default starting lineup consisting of specific players and assigned behaviors for upcoming matches. | |
| **Actors** | USER | |
...
| | 5 | The system validates the data, updates the record, and confirms the successful modification. |
| **Exceptions** | \# | **Action (Actor)** |
...
| **Main Success Scenario** | **\#** | **Action (Actor)** |
| | 1 | The user selects the option to see available leagues. |
...
| | 2 | The user inputs the required fields to create a league (name?,match\_time) |
...
| **Actors** | USER | |
| **Preconditions** | The user is authenticated and has a default team ([UC-11](#uc-11-create-default-team)). | |
| **Post-conditions** | The system successfully displays a list of available leagues. | |
| **Main Success Scenario** | **\#** | **Action (Actor)** |
| | 1 | The user selects the option to see available friendly matches. |
...
| | 2 | The system adds the user's club to the private league. |
| **Exceptions** | \# | **Action (Actor)** |
...
| | 2 | The system adds the user's club to the private match. |
| **Exceptions** | \# | **Action (Actor)** |
...
| **Post-conditions** | The user's club is removed from the match. | |
| **Main Success Scenario** | **\#** | **Action (Actor)** |
...
| | 2 | The system displays a confirmation dialog box to prevent the user from canceling by mistake. |
| | 3 | The user confirms the cancellation. |
| | 4 | The system deletes the match record, Removes the opponent if they joined, and confirms the dissolution to the user. |
| **Exceptions** | \# | **Action (Actor)** |
...
| **Actors** | USER | |
| **Preconditions** | The user created the league, the league has not yet started and has the required number of participants. | |
| **Post-conditions** | The league starts; at home, the league appears live in the league list and disappears from the list of available leagues. | |
| **Main Success Scenario** | **\#** | **Action (Actor)** |
...
| **Actors** | USER | |
| **Preconditions** | The user created the friendly match, the match has not yet started and has an opponent. | |
| **Post-conditions** | The match starts; at home, the match appears live in the friendly matches list and disappears from the list of available matches. | |
| **Main Success Scenario** | **\#** | **Action (Actor)** |
